...
apply_once() {
    ...
    lock_val "7f" /proc/irq/default_smp_affinity
    ...
    set_corectl_param "busy_down_thres" "0:20 4:40 7:40"
    set_corectl_param "busy_up_thres" "0:40 4:70 7:60"
    set_corectl_param "offline_delay_ms" "0:100 4:100 7:50"
